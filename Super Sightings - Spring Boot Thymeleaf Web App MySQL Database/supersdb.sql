drop database if exists supersdb;
...
-- select * from power;
-- select * from location inner join sighting on location.id = sighting.locationId where sighting.id = 1;
-- select * from sighting order by `date` desc limit 10;

-- select *
-- from `organization`
-- inner join hero_organization on `organization`.id = hero_organization.organizationId
-- where hero_organization.heroId = 1;
-- inner join hero on hero_organization.heroId = hero.id 

-- select * 
-- from hero 
-- inner join hero_organization on hero.id = hero_organization.heroId
-- where hero_organization.organizationId = 1;
...
-- select * from hero inner join hero_organization on hero.id = hero_organization.heroId inner join `organization` on hero_organization.organizationId = `organization`.id